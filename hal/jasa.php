            ...
            <div class="product">
                <div class="product-list">
                    ...
                    <div class="product-name">
                        <h4>Helmet</h4>
                            <p>Capstone Sun Shield II H31 Modular Helmet</p>
                        </div>
                    </div>
                    <div class="product-list">
                        <div class="product-image">
                        ...
                        <div class="product-name">
                            <h4>Gloves</h4>
                                <p>Setiap putaran roda adalah sebuah cerita, dan di setiap cerita diperlukan perlindungan yang tepat. Gloves Urban Riders adalah pasangan setia Anda dalam setiap petualangan motor..</p>
                            </div>
                        </div>
                        <div class="product-list">
                            <div class="product-image">
